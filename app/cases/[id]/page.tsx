    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-5xl px-6 py-16 lg:py-20">
          ...
          {item.customerInn ? (
            <div className="mt-6 rounded-3xl border border-slate-200 bg-slate-50/80 p-6 shadow-sm">
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
            <article className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              <div className="space-y-10">
                ...
                {item.result ? (
                  <section className="rounded-3xl border border-[rgba(8,26,75,0.1)] bg-[rgba(8,26,75,0.04)] p-6">
                    <h2 className="text-2xl font-semibold text-[#081a4b]">
                      Практический вывод
                    </h2>
                    <p className="mt-4 whitespace-pre-line text-base leading-8 text-slate-700">
                ...
                <div className="mt-5 space-y-4">
                  {relatedLinks.map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
                      className="block rounded-2xl border border-slate-200 bg-slate-50/70 p-4 transition hover:bg-slate-50"
                    >

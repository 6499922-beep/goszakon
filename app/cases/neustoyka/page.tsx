...
export default async function PenaltyPracticeHubPage() {
  ...
  const otherHubs = PRACTICE_HUBS.filter((item) => item.href !== "/cases/neustoyka").slice(0, 2);
        ...
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="mb-10 grid gap-6 md:grid-cols-2">
            ...
            >
              ...
              <p className="mt-4 text-base leading-8 text-slate-700">
                Когда ошибку в УПД, накладной или акте превращают в денежную
            ...
            <div className="grid gap-5">
              ...
              >
                ...
                <p className="mt-3 text-sm leading-7 text-slate-600">
                  ...
                  конфликтов, начните с обзорного навигатора по темам практики.
                </p>
              </Link>

...
export default function Home() {
  ...
  const categories = [
    ...
    { title: "Ограничение конкуренции", href: null },
        ...
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="mb-8">
            ...
            <p className="mt-3 max-w-3xl text-lg leading-8 text-slate-700">
              Ключевые направления, по которым формируется практика и по которым поставщики
              чаще всего обращаются за правовой оценкой закупки.
            </p>
          </div>

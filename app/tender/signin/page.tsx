      ...
      <div className="grid w-full max-w-5xl gap-8 lg:grid-cols-[1.05fr_420px]">
        <section className="rounded-[2rem] bg-[#081a4b] p-10 text-white shadow-2xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/78">
            Здесь команда будет вести закупку по шагам: от первичного анализа
            и стоп-факторов до предпросчета, сборки документов и финального
            пакета на подачу.
          </p>

          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            {[
              "Чек-лист и стоп-факторы",
              "Предпросчет и передача в работу",

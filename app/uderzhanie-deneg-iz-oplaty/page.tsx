...
const firstDocuments = [
  "контракт и приложения с условиями об оплате и ответственности;",
  "расчет удержанной суммы, претензия и документы, на которые ссылается заказчик;",
  "платежные документы, УПД, акты, накладные и переписка по спору;",
  "документы о приемке, замечаниях или внутренних требованиях заказчика, если удержание связано с ними.",
];
          ...
          <div className="grid gap-5">
            ...
            <div className="rounded-3xl bg-[#081a4b] p-7 text-white shadow-sm">
              ...
              <div className="mt-5 rounded-2xl border border-white/10 bg-white/5 p-4 text-sm leading-7 text-white/90">
                Работаем по всей России: можно дистанционно прислать пакет по
                удержанию и быстро понять, есть ли у заказчика вообще право на
                такую схему.
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-4 text-slate-700">
                Когда спорную санкцию используют как условие для самого факта
                оплаты по контракту.
              </p>
            </Link>

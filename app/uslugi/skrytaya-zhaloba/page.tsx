      ...
      <section className="border-b border-slate-200">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <h1 className="text-5xl font-bold tracking-tight text-[#081a4b]">
            Защита без раскрытия инициатора
          </h1>

          <p className="mt-6 max-w-3xl text-lg leading-9 text-slate-700">
            В части ситуаций поставщику важно инициировать правовую проверку закупки
            максимально аккуратно. Мы оцениваем, какие законные инструменты доступны
            в таком сценарии и как безопасно выстроить позицию.
          </p>

      ...
      <section className="border-b border-slate-200">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-9 text-slate-700">
            Если заказчик не оплачивает исполненный контракт, затягивает расчёты или
            ссылается на формальные основания, важно быстро собрать документы и
            выбрать рабочую стратегию взыскания.
          </p>
